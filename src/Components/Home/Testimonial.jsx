        ...
        <div className="flex flex-col lg:flex-row items-center space-y-20 lg:space-y-0">
          <div className="space-y-5  lg:space-y-7">
            <div className="space-y-6 lg:space-y-8">
              ...
              <h1 className="font-manrope font-medium text-42 text-[#4B4B4B] max-w-[406px]">
                See what their story is with us
              </h1>
            </div>
            <p className="font-manrope font-light text-22 text-[#4B4B4B] max-w-[710px]">
            ...
            <div className="space-y-1">
              <h1 className="font-manrope font-medium text-[#68BF33] text-3xl md:text-5xl lg:text-[82px]">
                200{" "}
                <span className="font-manrope font-light text-[#68BF33] text-3xl md:text-5xl lg:text-[82px]">
                  +
                </span>
              </h1>
              <p className="font-manrope font-light text-[#4B4B4B] text-22">
                Reviews
              </p>
            </div>
          </div>
